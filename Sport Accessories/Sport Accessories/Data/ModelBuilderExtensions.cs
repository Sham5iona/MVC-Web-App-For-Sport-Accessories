...
namespace Sport_Accessories.Data
{
    public static class ModelBuilderExtensions
    {
        ...
        public static void Seed(this ModelBuilder builder)
        {
            ...
            //Add claims to the admins for the CRUD operations and the SuperAdmin
            //to be able to manage each of their CRUD abilities
            ...
            var adminClaim = new[]
            {
                ...
                new IdentityUserClaim<string>
                {
                    Id = 4,
                    UserId = admin.Id,
                    ClaimType = read_claim.Type,
                    ClaimValue = read_claim.Value,
                }
            };
